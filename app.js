...
// Menu Principal Retrátil (Rodapé)
...
// Menu Lateral Independente da Caneta
btnTogglePen.addEventListener('click', () => {
  penSideWrapper.classList.toggle('collapsed');
  btnTogglePen.textContent = penSideWrapper.classList.contains('collapsed') ? '🎨 Caneta ▶' : '🎨 Caneta ▼';
});
...
// Seleção de Cor no Menu Lateral da Caneta
