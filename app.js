...
async function startCamera() {
  ...
  try {
    const stream = await navigator.mediaDevices.getUserMedia({
      video: { facingMode: currentFacingMode, width: { ideal: 720 }, height: { ideal: 1280 } },
      audio: true
    });
...
// Gravação Composta Vertical (720x1280)
