...
// Menu Principal Retrátil (Abre para cima)
...
// Menu Caneta Retrátil (Abre para a esquerda/lateralmente)
btnTogglePen.addEventListener('click', () => {
  penMenu.classList.toggle('collapsed');
  btnTogglePen.textContent = penMenu.classList.contains('collapsed') ? '🎨 Caneta ◀' : '🎨 Caneta ▶';
});
...
// Seletor de Cores (Incluso Cor Preta)
