...
/*
  =========================================================
  TRANSIÇÃO VISUAL DA TROCA DE CÂMERA
  =========================================================

  Captura o último quadro visível da câmera e o mantém
  temporariamente sobre o vídeo enquanto o iOS/WebKit
  reorganiza a nova câmera.
*/
function createCameraTransitionFrame() {
  ...
  try {
    ...
    /*
      Mantém o mesmo espelhamento visual
      usado pela câmera frontal.
    */
    if (facingMode === "user") {

      snapshotCtx.translate(
        snapshot.width,
        0
      );
    ...
    console.log(
      "Não foi possível congelar quadro:",
      error
    );
  ...
  /*
    A camada fica somente acima do vídeo
    e abaixo do canvas principal da lousa.
  */
  ...
  /*
    Coloca o quadro imediatamente depois
    do vídeo no DOM.
  */
