...
// Inicialização da Câmera respeitando Orientação
async function startCamera() {
  if (video.srcObject) {
    video.srcObject.getTracks().forEach(track => track.stop());
  }

  // Define proporções ideais baseadas na orientação atual da tela
...
// Recarrega câmera em mudança de rotação da tela
