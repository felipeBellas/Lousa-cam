...
settingsBtn.addEventListener(
  ...
  event => {
    ...
    /*
      O botão Caneta passa a funcionar
      como liga/desliga da Pencil.
    */

    const pencilVisible =
      pencilFloat.classList.contains(
        "show"
      );


    /*
      O painel antigo não é mais aberto
      pelo botão principal.
    */
...
/* =========================================================
   PENCIL — EXPANDIR / RECOLHER / ARRASTAR
   ========================================================= */
...
/*
  ...
  Usamos o próprio botão principal
  como área de arraste.
*/

pencilHandle.addEventListener(
  "pointerdown",
  event => {
    ...
    pencilHandle.setPointerCapture(
      event.pointerId
    );
...
/*
  ...
  Se houve movimento:
  apenas termina o arraste.

  Se NÃO houve movimento:
  expande/recolhe a Pencil.
*/
...
pencilHandle.addEventListener(
  ...
  event => {
    ...
    try {
      ...
      pencilHandle.releasePointerCapture(
        event.pointerId
      );
...
/*
  Evita que a Pencil provoque
  desenho ou seleção no canvas.
*/
  ...
  button => {
    ...
    button.addEventListener(
      ...
      event => {
        ...
        /*
          Mantém o painel antigo
          sincronizado internamente.
        */
